...
- [ ] Mode question first (1/2/3, Mode 2 recommended); engagement parameters confirmed at GATE 1 — heterogeneous does not by itself imply heavier parameters, the customer's constraints do
